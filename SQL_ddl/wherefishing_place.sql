...
INSERT INTO fishing.free_place (title, description, image, entrance, boot, rating) VALUES ('Река «Чёрная» Бесплатная', '<p>Медленная, мелкая, извилистая река в Ленинградской области. Подходит для ловли мелкой рыбы.</p>
', '', '<p>зависит от места, в основном травянистые берега. На реке есть мосты (на карте ниже)</p>
', '<p>река очень мелкая и узкая, рыбачить с лодки, вероятно, нет смысла</p>
', 1);